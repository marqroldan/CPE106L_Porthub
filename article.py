...
# Form implementation generated from reading ui file 'articleclicked.ui'
#
...
class Ui_ArticleWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1060, 812)
...
"background-color: qlineargradient(spread:pad, x1:0.905473, y1:0.886, x2:1, y2:1, stop:0.940299 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        spacerItem9 = QtWidgets.QSpacerItem(268, 47, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
...
"background-color: rgb(0, 0, 0);")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 932, 214))
...
"background-color: rgb(0, 0, 0);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 682, 214))
...
if __name__ == "__main__":
    ...
    ArticleWindow = QtWidgets.QMainWindow()
    ui = Ui_ArticleWindow()
    ui.setupUi(self.ArticleWindow)
    ArticleWindow.show()
    sys.exit(app.exec_())
