...
# Form implementation generated from reading ui file 'D:/Downloads/articlewin.ui'
#
...
import sqlite3
class Ui_ProductWindow3(object):
...
"background-color: qlineargradient(spread:pad, x1:0.905473, y1:0.886, x2:1, y2:1, stop:0.940299 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.image.setText("")
        self.image.setPixmap(QtGui.QPixmap("product pics//3.jpg"))
...
"background-color: rgb(0, 0, 0);")
        ...
        self.textEdit = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
##############
    ...
    def Send(self):
        ...
        connection = sqlite3.connect("Comments.db")
        connection.execute("INSERT INTO CTABLE (USERNAME, COMMENT, ID) VALUES (?, ?, ?)", (user, comment, 3))
        connection.commit()
        connection.close()
...
############################
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Product Name: \nKingston HyperX Fury Black 4GB 2666MHz 4GB DDR4 CL15 SDRAM (HX426C15FB/4) Memory Module \n\nPrice: ₱1,100.00\n"))
        self.label_2.setText(_translate("MainWindow", "Details:\nHyperX HX426C15FB/4 is a 512M x 64-bit (4GB) DDR4-2666 CL15 SDRAM (Synchronous DRAM) 1Rx8, memory module, based on eight 512M x 8-bit FBGA components per module."))
...
if __name__ == "__main__":
    ...
    ProductWindow3 = QtWidgets.QMainWindow()
    ui = Ui_ProductWindow3()
    ui.setupUi(ProductWindow3)
    ProductWindow3.show()
    sys.exit(app.exec_())
