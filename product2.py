...
class Ui_ProductWindow2(object):
...
"background-color: qlineargradient(spread:pad, x1:0.905473, y1:0.886, x2:1, y2:1, stop:0.940299 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.image.setText("")
        self.image.setPixmap(QtGui.QPixmap("product pics//2.jpg"))
...
"background-color: qlineargradient(spread:pad, x1:0.905473, y1:0.886, x2:1, y2:1, stop:0.940299 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Product Name: \nSeagate 500GB Barracuda 2.5 SATA (STZA500CM1A002) Solid State Drive \n\nPrice: ₱3,500.00\n"))
    ...
    def AddCart(self):
        ...
        cName.write('Seagate 500GB Barracuda 2.5 SATA (STZA500CM1A002) Solid State Drive\n')
        cPrice.write('3500.00\n')

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ProductWindow2 = QtWidgets.QMainWindow()
    ui = Ui_ProductWindow2()
    ui.setupUi(ProductWindow2)
    ProductWindow2.show()
    sys.exit(app.exec_())
