...
import sqlite3
class Ui_ProductWindow5(object):
...
##############
    ...
    def Send(self):
        ...
        connection = sqlite3.connect("Comments.db")
        connection.execute("INSERT INTO CTABLE (USERNAME, COMMENT, ID) VALUES (?, ?, ?)", (user, comment, 5))
        connection.commit()
        connection.close()
...
if __name__ == "__main__":
    ...
    ProductWindow5 = QtWidgets.QMainWindow()
    ui = Ui_ProductWindow5()
    ui.setupUi(ProductWindow5)
    ProductWindow5.show()
    sys.exit(app.exec_())
