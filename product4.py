...
class Ui_ProductWindow4(object):
...
"background-color: qlineargradient(spread:pad, x1:0.905473, y1:0.886, x2:1, y2:1, stop:0.940299 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.image.setText("")
        self.image.setPixmap(QtGui.QPixmap("product pics//4.jpg"))
...
##############
    ...
    def Send(self):
        ...
        connection = sqlite3.connect("Comments.db")
        connection.execute("INSERT INTO CTABLE (USERNAME, COMMENT, ID) VALUES (?, ?, ?)", (user, comment, 4))
        connection.commit()
        connection.close()
...
############################
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Product Name: \nKingston ValueRAM 16GB DDR4 2666MHZ SODIMM (KVR26S19D8/16) \n\nPrice: ₱3,500.00\n"))
        self.label_2.setText(_translate("MainWindow", "Details:\nCompetitively priced ValueRAM memory delivers award-winning performance. Designed and tested to meet JEDEC industry standards."))
...
if __name__ == "__main__":
    ...
    ProductWindow4 = QtWidgets.QMainWindow()
    ui = Ui_ProductWindow4()
    ui.setupUi(ProductWindow4)
    ProductWindow4.show()
    sys.exit(app.exec_())
