...
"background-color: qlineargradient(spread:pad, x1:0.905473, y1:0.886, x2:1, y2:1, stop:0.940299 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.image.setText("")
        self.image.setPixmap(QtGui.QPixmap("product pics//6.jpg"))
...
"background-color: qlineargradient(spread:pad, x1:0.905473, y1:0.886, x2:1, y2:1, stop:0.940299 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
    ...
    def AddCart(self):
        ...
        cName.write('Western Digital Blue 1TB SATA (WD10EZEX) Hard Drive\n')
        cPrice.write('2100.00\n')

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ProductWindow6 = QtWidgets.QMainWindow()
    ui = Ui_ProductWindow6()
    ui.setupUi(ProductWindow6)
    ProductWindow6.show()
    sys.exit(app.exec_())
